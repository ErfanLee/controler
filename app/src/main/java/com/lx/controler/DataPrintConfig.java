...
/**
 * Created by pc02 on 2021/12/6.
 */

public class DataPrintConfig extends LinearLayout {
    Context m_context;
    ...
    public DataPrintConfig(Context context, AttributeSet attrs){
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.data_print_config, this);
        checkBoxUsart1 =view.findViewById(R.id.data_print_usart1);
        checkBoxUsart2 =view.findViewById(R.id.data_print_usart2);
        checkBoxUsart3 =view.findViewById(R.id.data_print_usart3);
        checkBoxUsart4 =view.findViewById(R.id.data_print_usart4);
        checkBoxUsart5 =view.findViewById(R.id.data_print_usart5);
        checkBoxUsart6 =view.findViewById(R.id.data_print_usart6);
        checkBoxIIC =view.findViewById(R.id.data_print_IIC);
        checkBoxSPI =view.findViewById(R.id.data_print_SPI);
        checkbox_data_print=view.findViewById(R.id.checkbox_data_print);
    }
    ...
    boolean isChecked(){
        return checkbox_data_print.isChecked();
    }
}